...
# frame=create_cadics(develop_case,market,power_train,project_name)
# print(frame)
# update_new(project_name,market,power_train,develop_case,frame)
# x,frame,y,z=query_data(project_name,market,power_train,develop_case,"ALL","ALL")
#frame.to_csv("cadic_query.csv", index=False, header=None)
